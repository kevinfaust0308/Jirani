...
contract LoanRequestPlatform {
    ...
    function extractLoanRequestContractData(address _contract) view public ownerOnly returns (address, uint, uint, string memory, string memory, string memory, uint){
        ...
        return (lr.requestee(), lr.amountRequested(), lr.amountAccumulated(), lr.title(), lr.reason(), lr.repaymentPlan(), lr.numLoaners());
